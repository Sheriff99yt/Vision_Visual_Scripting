...
class Edge():
    def __init__(self, scene, start_socket, end_socket, edge_type=EDGE_TYPE_DIRECT):
        ...
        self.graphicsEdge = MyGraphicsEdgeDirect(self) if edge_type == EDGE_TYPE_DIRECT else MyGraphicsEdgeBezier(self)

        self.updatePositions()
        if DEBUG: print("Edge: ", self.graphicsEdge.posSource, "to", self.graphicsEdge.posDestination)
        self.scene.graphicScene.addItem(self.graphicsEdge)
    ...
    def remove(self):
        ...
        self.scene.grScene.removeItem(self.graphicsEdge)
